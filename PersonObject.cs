...
namespace PersonStaffStudent
{
    class PersonObject
    {
        static void Main(string[] args)
        {
            ...
            Person[] people = {
                                new Person("Rakshaj", "Bangalore", "Karnataka", " fundamentals", 2010, 4500.0),
                                new Person("Vikas", "Bangalore"," Karnataka", "Delhi Public school", 35000.0),
                                new Person("Santosh", "Bangalore", "Karnataka", "National Public school", 42000.0),
                                new Person("PL", "Hassan", "Karnataka", " fundamentals", 2012, 4750.0),
                                new Person("Shiva", "Vasco", "Goa", "Reactjs", 2017, 12500.0)
                                };
            Console.ReadLine();
        }
    }
